...
generate_plot(df, primary_df_group, start_date, end_date, "reportedDate", "caseNumber", "description", 30, "by_description")
generate_plot(df, primary_df_group, start_date, end_date, "reportedDate", "caseNumber", "offense", 30, "by_offense")
