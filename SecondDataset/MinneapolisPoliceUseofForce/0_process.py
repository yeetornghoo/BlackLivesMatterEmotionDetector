...
# SETTING
dir_path = "C:/workspace/SocialMovementSentiment/SecondDataset/MinneapolisPoliceUseofForce/"
...
def generate_plot(df_s, df_p, start_date, end_date, x_attr, y_attr, h_attr, y_factor, sub_report_name):
    ...
    plt.title("Total #BLM Tweets v.s. Minneapolis Police Use Force ({})".format(sub_report_name.replace("_", " ")).upper(), fontsize='25')
    plt.savefig("{}img/lineplot_comparison_{}.png".format(dir_path, sub_report_name))
    plt.close()


generate_plot(df, primary_df_group, start_date, end_date, "ResponseDate", "CaseNumber", "TypeOfResistance", 100, "by_TypeOfResistance")
generate_plot(df, primary_df_group, start_date, end_date, "ResponseDate", "CaseNumber", "Problem", 100, "by_Problem")
generate_plot(df, primary_df_group, start_date, end_date, "ResponseDate", "CaseNumber", "Is911Call", 100, "by_Is911Call")
generate_plot(df, primary_df_group, start_date, end_date, "ResponseDate", "CaseNumber", "PrimaryOffense", 100, "by_PrimaryOffense")
generate_plot(df, primary_df_group, start_date, end_date, "ResponseDate", "CaseNumber", "SubjectInjury", 100, "by_SubjectInjury")
generate_plot(df, primary_df_group, start_date, end_date, "ResponseDate", "CaseNumber", "ForceType", 100, "by_ForceType")
generate_plot(df, primary_df_group, start_date, end_date, "ResponseDate", "CaseNumber", "ForceTypeAction", 100, "by_ForceTypeAction")
generate_plot(df, primary_df_group, start_date, end_date, "ResponseDate", "CaseNumber", "Race", 100, "by_Race")
generate_plot(df, primary_df_group, start_date, end_date, "ResponseDate", "CaseNumber", "Sex", 100, "by_Sex")
generate_plot(df, primary_df_group, start_date, end_date, "ResponseDate", "CaseNumber", "EventAge", 100, "by_EventAge")
