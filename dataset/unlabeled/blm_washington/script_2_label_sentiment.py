...
# REMOVE COLUMNS
df.drop(['tweet_id', 'permalink', 'username', 'to_person', 'mentions', 'hashtags', 'geo',
         'record_inserted_date', 'state', 'radius', 'search_keyword', 'final_tweet_text'], axis=1, inplace=True)
