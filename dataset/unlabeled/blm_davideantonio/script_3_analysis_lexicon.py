...
min_intensity = 1.2
dir_path = "C:/workspace/SocialMovementSentiment/dataset/unlabeled/blm_davideantonio/"
...
BarPlotViz.generate_barplot(df_count, "David Eantonio Sentiment Tweet Account", "Sentiment", "# of Tweets", img_path)
