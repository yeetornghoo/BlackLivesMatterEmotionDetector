...
def generate_bellcurve(df, percentage, ax):
    ...
    ax.text((q3_value+0.1), 0.4, "{}% or density {} and above".format((percentage * 100), q3_value))
    ax.text((mean_value+0.1), 0.05, "Mean: {}".format(mean_value), horizontalalignment='left')
